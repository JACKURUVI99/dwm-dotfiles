...
static const char *fonts[]          = { "Space Mono:pixelsize=16:antialias=true;autohint=true" };
static const char dmenufont[]       = "Space Mono:pixelsize=16:antialias=true:autohint=true";
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_BackSpace,          quit,           {0} },  
       ...
       { MODKEY,                       XF86XK_AudioRaiseVolume, spawn, SHCMD("amixer set Master 5%+") },
       { MODKEY,                       XF86XK_AudioLowerVolume, spawn, SHCMD("amixer set Master 5%-") },
